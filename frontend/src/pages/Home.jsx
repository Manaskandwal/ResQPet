...
const steps = [
    { icon: '📝', title: 'Report', desc: 'Spot a stray or pet in distress and log a request with location.' },
    { icon: '🤝', title: 'Respond', desc: 'Nearby verified partners are notified and can accept if available.' },
    { icon: '⚡', title: 'Escalate', desc: 'System alerts available partners who try their best to provide a response.' },
    { icon: '✅', title: 'Resolve', desc: 'Partner resolves the case. Our future roadmap connects you with vets!' },
];
    ...
    if (loading) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <PawLoader message="Checking authentication..." />
            </div>
        );
    }
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-primary-50/40 to-accent-50/30 flex items-center justify-center py-16 sm:py-20">
                ...
                <div className="relative max-w-4xl mx-auto px-5 text-center">
                    ...
                    <div className="mt-12 flex flex-wrap justify-center gap-x-8 gap-y-4 text-sm font-medium text-slate-500 animate-fade-in">
                        ...
                        <span className="flex items-center gap-1.5"><span className="text-green-500">✓</span> Hybrid Services Coming</span>
                        <span className="flex items-center gap-1.5"><span className="text-green-500">✓</span> Best-effort emergency aid</span>
                        <span className="flex items-center gap-1.5"><span className="text-green-500">✓</span> Verified Partner Network</span>
                    </div>
                </div>
            </section>
