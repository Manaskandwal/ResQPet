...
export const SkeletonRow = () => (
    <div className="flex items-center gap-4 p-4 animate-pulse">
        <div className="w-10 h-10 bg-slate-200 dark:bg-white/10 rounded-full flex-shrink-0" />
...
export const SkeletonStatCard = () => (
    <div className="stat-card animate-pulse">
        <div className="w-10 h-10 bg-slate-200 dark:bg-white/10 rounded-btn mb-3" />
        <div className="h-8 bg-slate-200 dark:bg-white/10 rounded w-1/2 mb-2" />
